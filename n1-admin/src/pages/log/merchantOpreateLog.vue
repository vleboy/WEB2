<template>
    <div class="opreateLog">
        ...
        <div class="table">
            <Table :columns="columns1" :data="opreateLog" size="small" ></Table>
        </div>
        <div class="btn">
...
export default {
  ...
  computed: {
    opreateLog() {
      return this.$store.state.admin.merchantOprateLog;
    }
  },
  methods: {
    nextPage() {
      ...
      this.$store.dispatch("getMerchantOpreateLog",params );
