    ...
    return(
        ...
        <div className="banner clearfix">
			...
			<div className="content clearfix">				
				...
				<div className="des">比较“红牛”与“黑牛”的牌型大小，牌型较大的一方赢，牌型小的一方则输，牌型相同即为和局，特殊牌型投注区押中两方任一牌型即赢。</div>
			  ...
			  <div className="table2 clearfix">
					<span className="c1"><p className="txt1">5小牛</p></span>
					<span className="c1"><div className="t-01"></div></span>
					<span className="c1"><p className="txt2">每张牌都小于5<br/>且所有牌加起來小於或等於10</p></span>
                    
					<span className="c1"><p className="txt1">炸弹</p></span>
					<span className="c1"><div className="t-02"></div></span>
					<span className="c1"><p className="txt2">5张牌里有4张相同点数的牌</p></span>
                    
					<span className="c1"><p className="txt1">金牛</p></span>
					<span className="c1"><div className="t-03"></div></span>
					<span className="c1"><p className="txt2">5张牌都为10以上的牌不包括10</p></span>
                    
					<span className="c1"><p className="txt1">银牛</p></span>
					<span className="c1"><div className="t-04"></div></span>
					<span className="c1"><p className="txt2">5张牌都为10及以上的牌至少包括1张10</p></span>
                    
					<span className="c1"><p className="txt1">牛牛</p></span>
					<span className="c1"><div className="t-05"></div></span>
					<span className="c1"><p className="txt2">任意3张牌之和为10的倍数<br/>其余2张之和也为10的倍数</p></span>
                    
					<span className="c1"><p className="txt1">牛9</p></span>
					<span className="c1"><div className="t-06"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为9或19</p></span>
                    
					<span className="c1"><p className="txt1">牛8</p></span>
					<span className="c1"><div className="t-07"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为8或18</p></span>
                    
					<span className="c1"><p className="txt1">牛7</p></span>
					<span className="c1"><div className="t-08"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为7或17</p></span>
                    
					<span className="c1"><p className="txt1">牛6</p></span>
					<span className="c1"><div className="t-09"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为6或16</p></span>
                    
					<span className="c1"><p className="txt1">牛5</p></span>
					<span className="c1"><div className="t-10"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为5或15</p></span>
                    
					<span className="c1"><p className="txt1">牛4</p></span>
					<span className="c1"><div className="t-11"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为4或14</p></span>
                    
                    <span className="c1"><p className="txt1">牛3</p></span>
					<span className="c1"><div className="t-12"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为3或13</p></span>
                    
                    <span className="c1"><p className="txt1">牛2</p></span>
					<span className="c1"><div className="t-13"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为2或12</p></span>
                    
                    <span className="c1"><p className="txt1">牛1</p></span>
					<span className="c1"><div className="t-14"></div></span>
					<span className="c1"><p className="txt2">3张10的倍数组合<br/>剩余2张相加为1或11</p></span>
                    
					<span className="c1"><p className="txt1">无牛</p></span>
					<span className="c1"><div className="t-15"></div></span>
					<span className="c1"><p className="txt2">五张牌中没有任意三张牌<br/>点数之和为10的整数倍</p></span>					
			  </div>
				...
				<div className="table4 clearfix">
					...
					<span className="t2">赔率</span>
                    <span className="c1">黑牛</span>
					<span className="c2"><strong>1 : 0.95</strong></span>
					<span className="c1">红牛</span>
					<span className="c2"><strong>1 : 0.95</strong></span>                    
					<span className="c1">和</span>	
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛一</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛二</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛三</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛四</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛五</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛六</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛七</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛八</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛九</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">牛牛</span>
					<span className="c2"><strong>1 : 5</strong></span>
					<span className="c1">双牛牛</span>
					<span className="c2"><strong>1 : 100</strong></span>
					<span className="c1">银牛/金牛/炸弹/五小牛</span>
