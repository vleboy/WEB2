...
import pailu1 from '../../imgs/pailu2.jpg'
import pailu3 from '../../imgs/pailu3.jpg'
const Pailu=()=>{
    return (
        <div>
            <div className="pailu_banner clearfix">
				<li className="title">牌路介绍</li>
				<li className="des">Road Map</li>
				<li className="pailu_bar"></li>
				<li className="intro"><strong>「路」</strong>的意思，是百家乐开牌的结果记录。</li>
			</div>
			<div className="pailu_content clearfix">
				<div className="title">
					<p>牌路介绍:</p>
					<p>
                        <img src={pailu1} className="img-responsive" alt='aa'/>
                        </p>
				</div>
				<div className="pailu_sub">1. 开牌结果的纪录</div>
				...
				<div className="pailu_sub">4. 小路</div>
				...
				<div className="pailu_sub">6. 庄问路丶闲问路</div>
				<div className="des2">此功能是模拟下一局如果开庄或闲时，大路丶大眼路丶小路丶小强路的结果。令玩家更方便及快速地判断该如何投注下一局。</div>
				<div className="pailu_des3">
					<p>如下图:</p>
					<p>
                        <img src={pailu3} className="img-responsive" alt='oo'/>
                    </p>
					<p>模拟下一局开庄或闲的路</p>
				</div>
