...
import ex from '../imgs/to/ex21.jpg'

const TwentyOne = () => {
  return (
    <div>
      <div className="banner21 clearfix">
				<li className="title">21点</li>
				<li className="bar21"></li>
        ...
        {/* <img src="images/bj/cap.jpg" className="img-responsive"> */}
			...
			<div className="content21 clearfix">
				<div className="title21">如何胜出</div>				
				<div className="des">
					玩家想要赢得牌局，手上的牌点数必需比荷官的牌点数大，尽量接近21点但不可超过21点，游戏不需理会其他玩家的牌点数，玩家只与荷官比牌点数。
				</div>
				<div className="title21">操作及下注指南:</div>
				<div className="rules">
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>1</span></div>
						<div className="col-xs-9 more"><span>玩家必须在规定的投注时间内确认下注</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>2</span></div>
						<div className="col-xs-9 more"><span>投注时间结束后，从荷官左侧的第１位玩家开始顺时针发牌，荷官会向每一位玩家派发第1张牌值向上的牌</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>3</span></div>
						<div className="col-xs-9 more"><span>最后荷官会发１张牌给荷官自己</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>4</span></div>
						<div className="col-xs-9 more"><span>荷官再向每一位玩家派发第２张牌值向上的牌</span></div>						
					</li>					
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>5</span></div>
						<div className="col-xs-9 more"><span>最后再发给自己第2张暗牌 (点数向下的牌)</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>6</span></div>
						<div className="col-xs-9 more"><span>荷官将顺序询问该玩家的相应动作，直至玩家停牌，荷官才询问下一位玩家</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>7</span></div>
						<div className="col-xs-9 more">
				...
				<div className="rules">						
					...
					<li className="r-bg clearfix">
						...
						<div className="col-xs-9 more"><span><strong>加注：</strong>1. 玩家可选择加倍下注，<br/>但加注后只获补发1张牌，即定输赢
				...
				<div className="title21">分牌流程:</div>
				<div className="rules">
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>10</span></div>
						<div className="col-xs-9 more"><span>分牌：分牌必须首2张牌为同等点数，可选择分开为2手牌，分出每门的下注金额须与原注相同。</span></div>
					</li>
				</div>
				<div className="des2">
				...
				<div className="rules">			
					<li className="r-bg clearfix">
						...
						<div className="col-xs-9 more"><span><strong>停牌：</strong>选择不再拿牌，以当时的手牌点数与荷官对抗</span></div>
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>12</span></div>
						<div className="col-xs-9 more"><span>当所有玩家完成所有动作后，荷官将揭开自己的底牌。荷官必须在17点或以上时停牌；在16点或以下时要牌。</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>13</span></div>
						<div className="col-xs-9 more"><span>如果你的点数比荷官的点数更接近21点，或荷官爆牌, 将判断玩家赢</span></div>						
					</li>					
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>14</span></div>
						<div className="col-xs-9 more"><span>如果你的牌面值与荷官总牌值相同时，则判断为平手。</span></div>						
					</li>
					<li className="r-bg clearfix">
						<div className="col-xs-3 num"><span>15</span></div>
						<div className="col-xs-9 more"><span>荷官回收已使用的牌</span></div>						
					</li>
				</div>					
				<div className="des">
					*注意：如在游戏过程中及玩家在没有爆牌的情况下，没有选择任何动作时，则默认停牌。
				</div>
				<div className="title21">游戏玩法</div>				
				<div className="des">
				...
				<div className="title21">游戏规则:</div>				
				...
				<div className="title21">点数大小:</div>
				...
				<div className="title21">牌值大小:</div>
				...
				<div className="title21">派彩 及 下注选择项目:</div>
				<div className="des3 clearfix">
              ...
              <br/>
				...
				<div className="title21">注意事项:</div>				
				<div className="des2 clearfix">
