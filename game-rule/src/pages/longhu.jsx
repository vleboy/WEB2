...
const Longhu =()=>{
    return(
        <div>
        <div className="long_banner clearfix">
				<li className="title">龙虎</li>
				<li className="des">Dragon Tiger</li>
				<li className="long_bar"></li>
				<li className="intro"><strong>龙虎</strong> 加入真人游戏平台後，让更多玩家於电脑以及任何移动装置连接我们的娱乐平台，感受犹如置身现场的享乐新体验，一试自己的运气！</li>
				<li className="long_cap"></li>
			</div>
			<div className="long_content clearfix">
				<div className="long_title">如何胜出:</div>
				<div className="long_des">正确预计两家  {'<<龙>>'} 和  {'<<虎>>'} 的点数比较大。</div>
				<div className="long_title">操作及下注指南:</div>
				<div className="rules">
					<li className="long_bg clearfix">
			...
			<div className="long_content clearfix">			
				<div className="long_title">游戏规则:</div>
				<div className="des2">
					<li><strong>1. </strong>牌面的大小不比花色，只比点数，K为最大牌，A为最小。</li>
					<li><strong>2. </strong>荷官先派发第一张牌于龙的位置，而第二张牌派发到虎的位置，牌面全是向上的，点数较大的胜出。</li>					
				</div>
				
				<div className="long_title">派彩赔率:</div>
				
				<div className="long_table clearfix">
					<li className="col-xs-6 t_title"><span>投注项目</span></li>
					<li className="col-xs-6 t_title"><span>赔率</span></li>
				...
				<div className="long_title">注意事项:</div>
				<div className="des2">
