...
//登录
export async function logIn(role,username,password,msn,challenge,vid,cb,err){
    return http(post('/users/auth',{role,username,password,msn,challenge,vid,cb,err}))
}
//查询平台用户账单统计
