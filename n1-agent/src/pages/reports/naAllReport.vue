        ...
        },
         {
          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              let winloseAmount = 0;
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["10000"]) {
                  winloseAmount = params.row.gameTypeMap[
                    "10000"
                  ].winloseAmount.toFixed(2);
                }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["10000"]) {
                  mixAmount = params.row.gameTypeMap["10000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["30000"]) {
                  mixAmount = params.row.gameTypeMap["30000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["40000"]) {
                  mixAmount = params.row.gameTypeMap["40000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["50000"]) {
                  mixAmount = params.row.gameTypeMap["50000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              let winloseAmount = 0;
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["60000"]) {
                  winloseAmount = params.row.gameTypeMap[
                    "60000"
                  ].winloseAmount.toFixed(2);
                }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["60000"]) {
                  mixAmount = params.row.gameTypeMap["60000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
         ...
         
        {
          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              let winloseAmount = 0;
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["80000"]) {
                  winloseAmount = params.row.gameTypeMap[
                    "80000"
                  ].winloseAmount.toFixed(2);
                }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["80000"]) {
                  mixAmount = params.row.gameTypeMap["80000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
...

        {
          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              let winloseAmount = 0;
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["90000"]) {
                  winloseAmount = params.row.gameTypeMap[
                    "90000"
                  ].winloseAmount.toFixed(2);
                }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["90000"]) {
                  mixAmount = params.row.gameTypeMap["90000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
