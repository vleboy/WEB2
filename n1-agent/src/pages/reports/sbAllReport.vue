          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["1120000"]) {
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["1120000"]) {
                  mixAmount = params.row.gameTypeMap["1120000"].mixAmount;
                }
              }
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            if (params.row.level == 0) {
              ...
              let winloseAmount = 0;
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["1080000"]) {
                  winloseAmount = params.row.gameTypeMap[
                    "1080000"
                  ].winloseAmount.toFixed(2);
                }
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.level == 0) {
              ...
              if (params.row.gameTypeMap) {
                if (params.row.gameTypeMap["1080000"]) {
                  mixAmount = params.row.gameTypeMap["1080000"].mixAmount;
                }
              }
              return h("span", thousandFormatter(mixAmount));
            }
